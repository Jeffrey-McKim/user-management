...
session_start(); //session will redirect a non logged in user back to the login page
...
<div class="col-sm-9">
  <?php
    $sql = "SELECT * FROM `usermanagement` WHERE username='$username'"; // I'm not sure what this is doing
...
<div class="panel-heading"><h4>User Profile</h4></div>
 <div class="panel-body">
      <div class="box box-info">
            <div class="box-body">
                     <div class="col-sm-6"> <!-- this profile picture functionality is not fully implemented yet -->
...
<div style="color:#999;" ><?php echo $username ?></div>
               <!--Upload Image Js And Css-->
                    </div>    
              <!-- /input-group -->
            </div>
           <div class="col-sm-6">
            <h4 style="color:#00b1b1;"><?php echo $username ?> </h4></span> <!-- dynamically dispalys username -->
